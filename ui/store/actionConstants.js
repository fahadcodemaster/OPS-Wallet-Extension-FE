...
// custom connect for P2P
export const CONNECT_P2P = 'CONNECT_P2P';
export const VALIDATESIGNATURE_P2P = 'VALIDATESIGNATURE_P2P';
export const ACCOUNT_MODIFICATION = 'ACCOUNT_MODIFICATION';
